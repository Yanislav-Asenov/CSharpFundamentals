namespace RecyclingStation.WasteDisposal.Interfaces
{
    ...
    public interface IProcessingData
    {
        ...
        /// <summary>
        /// The resulting profit/loss in capital from processing the garbage, if the number is negative it means the process cost more, than the amount of profits it provided. 
        /// </summary>
