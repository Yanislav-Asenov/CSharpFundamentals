namespace RecyclingStation.WasteDisposal.Interfaces
{
    ...
    /// <summary>
    /// Interface that specifies the behavior Strategy Holders have to implement.
    /// </summary>
    public interface IStrategyHolder
    {
        /// <summary>
        /// Returns a read only version of the collection of type Type-IGarbageDisposalStrategy, containing the currently mapped strategies.
        /// </summary>
        ...
        /// <returns>Returns false if the adding failed (for example if disposableAttribute already exists in the strategies) or true if the adding was successful. (</returns>
        ...
        /// <param name="disposableAttribute">A type derived from the Disposable Attribute class.</param>
        ///  <exception cref="ArgumentException">In case the disposableAttribute is not a type derived from the Disposable Attribute class throws an Argument Exception.</exception>
        /// <returns>Return false if the removal failed (ex. the passed in disposableAttribute is not contained in the current strategies) or returns true if the removing was successful.</returns>
